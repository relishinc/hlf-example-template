import { Application as PIXIApplication, Container, IApplicationOptions, Point, Sprite } from "pixi.js";
...
import { AnchorManager, AnchorPosition, IPadding, OrientationManager, ResizeManager, WebEventsManager } from "./Utils";
...
export declare abstract class Application extends PIXIApplication {
    ...
    anchor: OmitThisParameter<(object: Sprite, anchorPosition: AnchorPosition, padding?: IPadding, container?: Container) => void>;
     ...
     */
    protected constructor(pConfig?: IApplicationOptions & {
        [key: string]: any;
    });
